          ...
          <div className="space-y-4 lg:col-span-2">
            ...
            <div className="bg-dblue rounded-xl p-3">
              <Calendar className="h-8 w-8 text-white" />
                ...
                <h3 className="mb-6 flex items-center gap-3 page-ti  text-gray-900 dark:text-white">
              ...
              <div className="rounded-lg border bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
                ...
                <div className="mt-4">
                  <button
                    ...
                    className="bg-dblue group flex items-center gap-2 rounded-lg px-6 py-2.5  text-white shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl"
                  >
                    {state.btnLoading ? (
